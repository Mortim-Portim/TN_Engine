...
func (char *Character) SetEntityValues(e *Entity) {
	...
	e.SetMaxHealth(char.CompHealth(MODIFIER_HEALTH_BASE, MODIFIER_HEALTH_STR, MODIFIER_HEALTH_DEX))
	e.SetMaxStamina(char.CompStamina(MODIFIER_STAMINA_BASE, MODIFIER_STAMINA_STR, MODIFIER_STAMINA_DEX))
	e.SetMaxMana(char.CompMana(MODIFIER_MANA_BASE, MODIFIER_MANA_INT, MODIFIER_MANA_CHA))
	e.ResetHSM()
}
